...
My first dissertation project applies CCM to this question directly. Using two TSI reconstructions alongside both a global multi-archive global mean surface temperature data product and the long Greenland ice core record, I tested whether solar variability had a discernible influence on surface temperature over the Holocene. A key feature of this analysis is that CCM's parameter choices encode assumptions about the phasing and timescale of influence, and rather than endeavoring to find a single parameter configuration and hoping it was sufficiently representative of the climate's response to this subtle global forcing, we approached the project as a parameter sweep and interpreted the results as evidence that solar influence may exist on multiple time scales.
...
::: {.citation-list}
{{< include ../subpages/generated/nonlinear-causality/references.qmd >}}
:::

#### Talks

::: {.citation-list}
{{< include ../subpages/generated/nonlinear-causality/talks.qmd >}}
:::

#### Posters

::: {.citation-list}
{{< include ../subpages/generated/nonlinear-causality/posters.qmd >}}
:::
